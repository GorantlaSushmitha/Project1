                	...
                	<div class="item active">
                    	...
                    	<div class="container">
                        	<div class="carousel-caption">
                            	<h1>WELCOME TO THE BOOKS And DEVICES STORE</h1>
                            	<p>Here You Can Browse And Buy Books And Devices.</p>
                        	</div>
                    	</div>
                	</div>
                	<div class="item">
                	...
                	<div class="item">
                 	...
                 	<div class="item">
                    	...
                    	<div class="container">
                    	    <div class="carousel-caption">
                    	        <h1>THE DEVICES</h1>
                    	        <p>The Devices Which We Use In Our Daily Life.</p>
                    	    </div>
                 	   </div>
               	 	</div>
            	</div>
